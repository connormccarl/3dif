        ...
        <div className='grid grid-cols-1 gap-2'>
            <div>
                <div className='flex justify-center'>
                    <p className='pageTitle mb-2'>Our Clients</p>
                </div>
                <div className='grid grid-cols-2'>
                    <div className='text-center m-2 flex justify-center'>
                        <a href="https://www.va.gov/" target='_blank'>
                            <Image src="/images/client-logos/dept-veterans-affairs.png" alt="Department of Veterans Affairs" width={270} height={50} />
                            <p className='mt-2'>Department of Veterans Affairs</p>
                        </a>
                    </div>
                    <div className='text-center m-2 flex justify-center'>
                        <a href="https://www.blm.gov/" target='_blank'>
                            <Image className="text-center" src="/images/client-logos/bureau-land-management.png" alt="Department of the Interior - Bureau of Land Management" width={270} height={50} />
                            <p className='mt-2'>Department of the Interior -<br/>Bureau of Land Management</p>
                        </a>
                    </div>
                    <div className='text-center m-2 flex justify-center'>
                        <a href="https://www.dhs.gov/" target='_blank'>
                            <Image src="/images/client-logos/dept-homeland-security.png" alt="Department of Homeland Security" width={270} height={50} />
                            <p className='mt-2'>Department of Homeland Security</p>
                        </a>
                    </div>
                    <div className='text-center m-2 flex justify-center'>
                        <a href="https://www.ed.gov/" target='_blank'>
                            <Image src="/images/client-logos/dept-education.png" alt="Department of Education" width={270} height={50} />
